...
⏱ 50 mots`
  ...
  if (analysisResult) {
    ...
    const RESULT_CARDS: ResultCard[] = [
      ...
      { href: '/page-shopify', icon: <Globe className="w-6 h-6" />, iconBg: 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600', badge: null, badgeColor: '', badgeLabel: '', title: 'Générateur Fiche', desc: 'Fiche produit optimisée pour la vente avec les principes de Cialdini.', cta: 'Voir la fiche', accent: 'hover:border-emerald-400' },
