        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          {isPublished ? (
            <button
              ...
              className="flex items-center gap-2 px-3 md:px-4 py-1.5 bg-green-600 text-white text-sm font-bold rounded-lg hover:bg-green-700 transition-colors"
            >
              <Globe size={16} />
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50" onClick={() => setShowShare(false)}>
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-black text-lg text-gray-900">Boutique en ligne ! 🎉</h3>
                <p className="text-sm text-gray-500">Partage ce lien pour recevoir des commandes.</p>
              </div>
            </div>

            <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1.5">Lien de ta boutique</label>
            ...
            <div className="flex gap-2">
              ...
              >
                <ExternalLink size={16} /> Ouvrir la boutique
              </a>
              <button
