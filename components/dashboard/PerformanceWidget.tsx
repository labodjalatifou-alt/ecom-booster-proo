...
const storeData = {
  ALL: {
    closers: [
      { name: 'Fatou Diop', confirmed: 145, rate: '92%' },
      { name: 'Jean Kouassi', confirmed: 128, rate: '88%' },
      { name: 'Mamadou Diallo', confirmed: 98, rate: '85%' },
    ],
    livreurs: [
      { name: 'Ibrahim Touré', delivered: 120, success: '94%', cash: '2 450 000' },
      { name: 'Ousmane Sylla', delivered: 95, success: '89%', cash: '1 820 000' },
      { name: 'Aliou Cissé', delivered: 82, success: '86%', cash: '1 540 000' },
    ]
  },
  ABIDJAN: {
    closers: [
      { name: 'Jean Kouassi', confirmed: 88, rate: '89%' },
      { name: 'Awa Koné', confirmed: 64, rate: '82%' },
    ],
    livreurs: [
      { name: 'Ibrahim Touré', delivered: 85, success: '92%', cash: '1 650 000' },
      { name: 'Yaya Bamba', delivered: 62, success: '89%', cash: '1 240 000' },
    ],
  },
  DAKAR: {
    closers: [
      { name: 'Fatou Diop', confirmed: 92, rate: '94%' },
      { name: 'Cheikh Fall', confirmed: 78, rate: '86%' },
    ],
    livreurs: [
      { name: 'Ousmane Sylla', delivered: 75, success: '90%', cash: '1 420 000' },
      { name: 'Moussa Ndiaye', delivered: 54, success: '86%', cash: '980 000' },
    ],
  },
  CONAKRY: {
    closers: [
      { name: 'Mamadou Diallo', confirmed: 98, rate: '85%' },
      { name: 'Fanta Camara', confirmed: 54, rate: '78%' },
    ],
    livreurs: [
      { name: 'Aliou Cissé', delivered: 82, success: '86%', cash: '1 540 000' },
      { name: 'Sory Keita', delivered: 31, success: '82%', cash: '620 000' },
    ],
  }
};
...
export default function PerformanceWidget() {
  ...
  const data = storeData[selectedStore as keyof typeof storeData] || storeData.ALL;
